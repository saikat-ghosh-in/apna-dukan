                ...
                <div className="space-y-4 lg:sticky lg:top-4">
                    ...
                    <SectionCard title="Order Summary">
                        <div className="space-y-1 pb-3 border-b border-gray-100">
                            ...
                            <div className="flex justify-between text-xs"><span className="text-gray-500">Shipping</span><span className="font-semibold text-green-600">FREE</span></div>
                            {order.charges > 0 && (
                                <div className="flex justify-between text-xs"><span className="text-gray-500">Platform Fee</span><span className="font-semibold">{formatCurrency(order.charges)}</span></div>
                            )}
                        </div>
